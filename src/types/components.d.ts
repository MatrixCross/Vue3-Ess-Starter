...
declare module 'vue' {
  export interface GlobalComponents {
    ...
    ILocalNoFound: typeof import('~icons/local/no-found')['default']
    ILocalNoPermission: typeof import('~icons/local/no-permission')['default']
    ILocalServiceError: typeof import('~icons/local/service-error')['default']
...
declare global {
  ...
  const ILocalNoFound: typeof import('~icons/local/no-found')['default']
  const ILocalNoPermission: typeof import('~icons/local/no-permission')['default']
  const ILocalServiceError: typeof import('~icons/local/service-error')['default']
